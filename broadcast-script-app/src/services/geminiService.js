...
2. **나레이션 분량 (매우 중요)**:
   - 나레이션 길이는 컷의 duration(초)에 정확히 맞춰야 합니다
   - 한국어 나레이션은 1초에 약 3-4글자(공백 포함)를 읽습니다
   - 예시: 5초 컷 = 15-20자, 7초 컷 = 21-28자, 10초 컷 = 30-40자
   - 절대로 duration보다 긴 나레이션을 쓰지 마세요
   - 짧은 컷(4-5초)은 핵심 정보 1개만, 긴 컷(8-10초)은 2개까지
